    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-orange-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-2xl font-bold text-gray-900">Mirë se u kthyet!</h1>
          <p className="text-gray-500 mt-1 text-sm">Hyni në llogarinë tuaj</p>
        </div>
        ...
        <div className="card shadow-modal">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <a href="#" className="text-xs text-primary-500 hover:underline">Harruat fjalëkalimin?</a>
              </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-5">
            Nuk keni llogari?{' '}
            <Link to="/auth/register" className="text-primary-500 font-medium hover:underline">
              Regjistrohu falas
            </Link>
          </p>
        </div>
